...
try:
    for k in range(0, 12):
        ...
        month = k_month[k]
        year = '2018'
        url = "http://apis.data.go.kr/B552584/RfidFoodWasteServiceNew/getTotalDayList"
    ...
    body_total.to_csv('C:\\Users\\hogun\\PycharmProjects\\UDS_waste\\total_waste\\' + year + '_total_waste_byday.csv', index=False, encoding='utf-8-sig')
    print("Success")
except:
    print("Fail")
