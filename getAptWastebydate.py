    ...
    for j in range(1, len(apt_code_list)):
        ...
        try:
            for k in range(0, 12):
                ...
                month = k_month[k]
                year = '2018'
                url = "http://apis.data.go.kr/B552584/RfidFoodWasteServiceNew/getCityAptDateList"
            ...
            body_total.to_csv('C:\\Users\\hogun\\PycharmProjects\\UDS_waste\\apt_waste_' + year + '_bydate\\' + apt_code + '_' + year + '_waste.csv', index=False, encoding='utf-8-sig')
        except:
            print("Fail")
            print(url + queryParams)
            fail = apt_name + "_세대수_" + apt_citizen + "_링크_" + url + queryParams
            with open('C:\\Users\\hogun\\PycharmProjects\\UDS_waste\\apt_waste_' + year + '_bydate\\00_fail_list.csv', 'a', encoding='utf-8-sig') as csvfile:
