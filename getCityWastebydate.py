...
for i in range(1, len(city_code_list) + 1):
    ...
    try:
        ...
        body_total.to_csv('C:\\Users\\hogun\\PycharmProjects\\UDS_waste\\city_waste_' + year + '_bydate\\' + city_code + '_' + year + '_waste.csv', index=False, encoding='utf-8-sig')
    except:
        print("Fail")
        print(url + queryParams)
        fail = url + queryParams
        with open('C:\\Users\\hogun\\PycharmProjects\\UDS_waste\\city_waste_' + year + '_bydate\\00_fail_list.csv', 'a', encoding='utf-8-sig') as csvfile:
